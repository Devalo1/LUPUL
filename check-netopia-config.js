...
console.log(`   liveSignature: ${liveSignature ? 'SET (' + liveSignature.length + ' chars)' : 'NOT SET'}`);
...
console.log(`   NETOPIA_LIVE_SIGNATURE: ${process.env.NETOPIA_LIVE_SIGNATURE ? 'SET (' + process.env.NETOPIA_LIVE_SIGNATURE.length + ' chars)' : 'NOT SET'}`);
console.log(`   NETOPIA_LIVE_PUBLIC_KEY: ${process.env.NETOPIA_LIVE_PUBLIC_KEY ? 'SET' : 'NOT SET'}`);
console.log('');
