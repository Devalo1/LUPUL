...
async function testEmailRecovery() {
    ...
    try {
        ...
        console.log('📧 Prepared Email Data:', JSON.stringify(orderDataForEmail, null, 2));
        ...
        console.log('📤 Email Payload to send:', JSON.stringify(emailPayload, null, 2));
