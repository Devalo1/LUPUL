/**
 * Funcție Netlify pentru inițierea plăților EMBLEME prin NETOPIA (forma simplă care funcționează)
 * Această funcție procesează comenzile de embleme NFT și inițiază plățile folosind form POST
 */
...
// Configurație NETOPIA pentru embleme - folosește signature și form POST
  ...
  return {
    ...
    payment: {
      ...
      data: {
        ...
        currency: "RON",
        details: `🔮 ${paymentData.description || `Emblema ${paymentData.emblemType}`} - Acces exclusiv la comunitatea Lupul și Corbul`,
        billing: {
          type: "person",
...
/**
 * Trimite request la NETOPIA pentru inițierea plății emblemelor (forma simplă care funcționează)
 */
