 ...
 *
 * ROOT CAUSE: The previous implementation sent JSON to Netopia, which returned SVG.
 ...
 * ACEASTA ESTE SOLUȚIA PENTRU PROBLEMA BLANK PAGE
 */
...
export const handler = async (event, context) => {
  ...
  try {
    ...
    console.log("🔧 Store Environment configuration:", {
      baseUrl,
      isProduction,
      hasLiveCredentials,
      useLive,
