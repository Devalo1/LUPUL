    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-6 mt-4">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-red-600">Acces restricționat</h2>
          <p className="mt-2 mb-4">Nu aveți permisiunile necesare pentru a accesa panoul de administrare.</p>
          <button 
            onClick={() => navigate("/")}
          ...
          <div className="space-y-2">
            ...
            <Link
              ...
              className={`flex items-center justify-between w-full p-3 rounded-md ${
                isActive("/admin") ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-700"
              }`}
            >
              <div className="flex items-center">
            ...
            <div className="rounded-md overflow-hidden">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${activeDropdown === "products" ? "rotate-180" : ""}`} 
              ...
              {activeDropdown === "products" && (
                <div className="bg-white border-t border-gray-100">
                  <Link to="/admin/add-product" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Adaugă produs nou
                  </Link>
                  <Link to="/admin/categories" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Categorii produse
                  </Link>
                  <Link to="/admin/inventory" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Gestionare stocuri
                  </Link>
                  <Link to="/admin/products" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Toate produsele
                  </Link>
                </div>
              )}
            ...
            <div className="rounded-md overflow-hidden">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${activeDropdown === "events" ? "rotate-180" : ""}`} 
                  fill="none" viewBox="0 0 24 24" stroke="currentColor"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              ...
              {activeDropdown === "events" && (
                <div className="bg-white border-t border-gray-100">
                  <Link to="/admin/add-event" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Adaugă eveniment
                  </Link>
                  <Link to="/admin/events" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Toate evenimentele
                  </Link>
                </div>
              )}
            ...
            <Link
              to="/admin/appointments"
              className={`flex items-center justify-between w-full p-3 rounded-md ${
                isActive("/admin/appointments") ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-700"
              }`}
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="rounded-md overflow-hidden">
              ...
              >
                ...
                <svg 
                  className={`w-5 h-5 transition-transform ${activeDropdown === "users" ? "rotate-180" : ""}`} 
                  fill="none" viewBox="0 0 24 24" stroke="currentColor"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              ...
              {activeDropdown === "users" && (
                <div className="bg-white border-t border-gray-100">
                  <Link to="/admin/users" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Gestionare utilizatori
                  </Link>
                  <Link to="/admin/make-admin" className="block pl-11 pr-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                    Permisiuni admin
                  </Link>
                </div>
              )}
            ...
            <Link
              to="/admin/orders"
              className={`flex items-center justify-between w-full p-3 rounded-md ${
                isActive("/admin/orders") ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-700"
              }`}
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
            ...
            <Link
              to="/admin/articles"
              className={`flex items-center justify-between w-full p-3 rounded-md ${
                isActive("/admin/articles") ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-700"
              }`}
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                ...
                <span className="font-medium">Articole</span>
              </div>
            </Link>
            ...
            <Link
              to="/admin/settings"
              className={`flex items-center justify-between w-full p-3 rounded-md ${
                isActive("/admin/settings") ? "bg-blue-50 text-blue-600" : "bg-gray-50 text-gray-700"
              }`}
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
            ...
            <Link
              to="/"
              className="flex items-center justify-between w-full p-3 rounded-md bg-gray-50 text-gray-700"
            >
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clipRule="evenodd" />
                </svg>
                <span className="font-medium">Către site</span>
              </div>
            </Link>
          </div>
        </div>
