...
vi.mock('../services/userBehaviorAnalytics', () => ({
  userBehaviorAnalytics: {
    getAdminDashboardData: vi.fn(() => Promise.resolve({
      totalSessions: 100,
    ...
    getUserReadingProfile: vi.fn(() => Promise.resolve({
      userId: 'test-user',
...
describe('ReadingAnalyticsAdmin', () => {  it('should render analytics dashboard', async () => {
