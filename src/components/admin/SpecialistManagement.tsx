...
const updateUserSpecialization = async (
  userId: string,
    ...
    const fetchSpecialists = async () => {
      ...
      try {
        ...
        for (const userDoc of specialistSnapshot.docs) {
          ...
          const existingSpecialist = specialistsData.find(
            (s) => s.userId === userDoc.id
          );
        ...
        for (const specialist of specialistsData) {
          ...
          if (
            ...
            try {
              ...
              console.error(
                `Error fetching user data for specialist ${specialist.id}:`,
                error
              );
            }
          }
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            Nu s-au găsit specialiști care să corespundă criteriilor de căutare.
          </p>
        </div>
      ) : (
                        ...
                        <img
                          ...
                          onError={(e) => {
                            e.currentTarget.src =
                              ...
                              encodeURIComponent(getDisplayName(specialist)) +
                    ...
                    {editingSpecialistId === specialist.id ? (
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full px-2 py-1 text-sm border rounded"
                          aria-label="Selectează categoria de specializare"
                          title="Selectează categoria de specializare"
                        >
                          <option value="">
                            Selectează categoria (opțional)
                          </option>
                          {Array.isArray(SpecializationCategories) &&
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                    {editingSpecialistId === specialist.id ? (
                      <div className="flex justify-end space-x-2">
                        <button
                          onClick={() =>
                            handleUpdateSpecialization(specialist.id)
                          }
                          disabled={processing}
                          className="text-green-600 hover:text-green-900"
                          title="Salvează"
                          aria-label={`Salvează specializarea pentru ${getDisplayName(specialist)}`}
                        >
                          {processing ? (
                        ...
                        <button
                          ...
                          title="Anulează"
                          aria-label="Anulează editarea specializării"
                        >
                          <FaTimes />
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        aria-label={`Editează specializarea pentru ${getDisplayName(specialist)}`}
                      >
                        <FaEdit />
                      </button>
                    )}
