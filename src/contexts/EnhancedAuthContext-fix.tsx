...
// Define the enhanced Auth Provider that wraps the original one
interface AuthWrapperProviderProps {
  children: React.ReactNode;
}

export const AuthWrapperProvider: React.FC<AuthWrapperProviderProps> = ({ children }) => {
  ...
  // Create the enhanced auth context value with safe property access
