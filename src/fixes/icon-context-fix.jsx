...
// Inițializăm IconContext forțat
const IconContextValue = IconContext.Consumer;
console.log("IconContext pre-initialized");

// Export pentru a asigura că IconContext este încărcat complet
export { IconContext };
export default { IconContext, IconProvider, defaultIconContext, withIconContext };
