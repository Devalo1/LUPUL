      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              „Lupul și Corbul" nu e doar o rulotă – e o platformă locală de gust, cultură și regenerare. Aici servesc gogoși calde, cafea de specialitate, shake-uri, limonadă și alte gustări simple, dar făcute cu grijă. Fiecare produs are o poveste, un nume, un motiv să existe – nu doar pentru a umple stomacul, ci și pentru a aduce un zâmbet, o pauză, o clipă de tihnă.
            </p>
          </section>
