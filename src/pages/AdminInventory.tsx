...
const AdminInventory: React.FC = () => {
  ...
  // State pentru modificări de categorie înainte de salvare
  ...
  // Funcție pentru actualizarea categoriei unui produs
  const updateCategory = async (productId: string, newCategory: string) => {
    try {
      const prodRef = doc(db, "products", productId);
      await updateDoc(prodRef, { category: newCategory });
      setProducts((prev) =>
        prev.map((p) =>
          p.id === productId ? { ...p, category: newCategory } : p
        )
      );
      // Șterge change după salvare
      ...
      alert("Eroare la actualizarea categoriei produsului.");
    }
  };
  ...
  const fetchProductStockHistory = async (productId: string) => {
    try {
      ...
      alert(
        "Eroare la încărcarea istoricului stocului. Vă rugăm încercați din nou."
      );
    } finally {
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredProducts.length > 0 ? (
                    ...
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        <div className="text-sm text-gray-900">
                          {product.sku || "Fără SKU"}
                        </div>
                        <select
                          aria-label="Selectează categoria produsului"
                  ...
                  <tr>
                    ...
                    >
                      Nu s-au găsit produse care să corespundă criteriilor
                      selectate.
                    </td>
                  </tr>
                )}
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-md mx-4 p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                aria-label="Închide ajustare stoc"
                title="Închide"
              >
                <svg
                  className="h-6 w-6"
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    SKU: {selectedProduct.sku || "Fără SKU"}
                  </div>
                </div>
              </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-lg font-bold ${
                      ...
                      (selectedProduct.lowStockAlert || 5)
                        ? "text-red-600"
                        : "text-green-600"
                    }`}
                  >
          ...
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-3xl mx-4 p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-500"
                aria-label="Închide istoricul stocului"
                title="Închide"
              >
                <svg
                  className="h-6 w-6"
                    ...
                    {stockHistory.length > 0 ? (
                      ...
                      <tr>
                        <td
                          ...
                          className="py-4 px-4 text-center text-gray-500"
                        >
                          Nu există înregistrări în istoricul stocului pentru
                          acest produs.
                        </td>
                      </tr>
                    )}
