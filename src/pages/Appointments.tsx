...
const Appointments: React.FC = () => {
          ...
          const mockSpecialists: Specialist[] = [
            {
              ...
              description:
                "Specialist în terapia anxietății și depresiei cu 15 ani de experiență în psihoterapie. Expertă în tehnici cognitiv-comportamentale și mindfulness.",
              schedule: [
                {
                  dayOfWeek: 1,
                  startTime: "09:00",
            ...
            },
            {
              ...
              description:
                "Specialist în tulburări de personalitate și psihoze. Expert în terapie medicamentoasă și diagnostic psihiatric cu 20 de ani de practică.",
              schedule: [
                {
                  dayOfWeek: 1,
                  startTime: "10:00",
            ...
            },
            {
              ...
              imageUrl:
                "https://images.unsplash.com/photo-1594824792696-fd40caed4d62?w=150&h=150&fit=crop&crop=face",
              description:
                "Specialist în terapia cognitiv-comportamentală pentru adulți și copii. Focus pe fobii, atacuri de panică și tulburări de anxietate socială.",
              schedule: [
                {
                  dayOfWeek: 1,
                  startTime: "08:00",
    ...
    for (let i = 1; i <= 14; i++) {
      ...
      if (scheduleForDay) {
        ...
        days.push({
          ...
          dayName: new Date(formattedDate).toLocaleDateString("ro-RO", {
            weekday: "long",
          }),
          slots,
        });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const endTime = `${endTimeDate.getHours().toString().padStart(2, "0")}:${endTimeDate
        .getMinutes()
        .toString()
        .padStart(2, "0")}`;
      ...
      setError(
        "A apărut o eroare la salvarea programării. Vă rugăm încercați din nou."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="mb-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            ...
            Selectează specialistul care se potrivește cel mai bine nevoilor
            tale.
          </p>
          ...
          {specialists.length > 0 ? (
            specialists.map((specialist) => (
              <div
                ...
                onClick={() => {
                  // Navigăm direct către pagina specialistului
                  navigate(`/appointments/specialist/${specialist.id}`);
                }}
              >
                {/* Badge de selecție */}
                {selectedSpecialist === specialist.id && (
                ...
                <div className="flex items-start mb-6">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      Cabinet privat - {specialist.role}
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-3 text-center">
                    ...
                    <div className="text-xs text-gray-600 uppercase tracking-wide">
                      Rating ({specialist.reviewCount || 0} recenzii)
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      // Navigăm către pagina specialistului
                      navigate(`/appointments/specialist/${specialist.id}`);
                    }}
              ...
              <div className="max-w-md mx-auto">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9zM4 13a4 4 0 011-2.646V6.5a.5.5 0 01.5-.5h9a.5.5 0 01.5.5v3.854A4 4 0 0116 13v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
                ...
                <p className="text-gray-600 mb-6">
                  Momentan nu avem specialiști disponibili pentru programări. Te
                  rugăm să revii mai târziu sau să ne contactezi direct.
                </p>
          ...
          {days.map((day) => (
            ...
            >
              ...
              <p className="text-xs mt-1 text-gray-500">
                {day.slots.filter((slot) => slot.available).length} intervale
                disponibile
              </p>
            </button>
          ))}
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 mb-8 border border-white/20">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full mb-4">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M8 7V3a4 4 0 118 0v4m-4 9V7a3 3 0 113-3m-1 9l-3 3m0 0l-3-3m3 3V4"
                />
              </svg>
            </div>
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Alege un specialist din echipa noastră și programează o ședință
              personalizată pentru nevoile tale
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg">{renderStepContent()}</div>
        </div>

        {currentUser && step !== 4 && <UserAppointments />}

        <div className="mt-12 bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold mb-4 text-gray-800">
            De ce să programezi o ședință cu noi
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-blue-50 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Echipa noastră este formată din specialiști cu experiență vastă
                în domeniul lor.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-green-50 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Procesul de programare este simplu și rapid, cu confirmare
                instantă.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-purple-50 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Oferim suport continuu și răspunsuri la toate întrebările tale.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>
            ...
            <span className="text-blue-600">lupulsicorbul@gmail.com</span> sau
            sună la <span className="text-blue-600">0734 931 703</span>
          </p>
        </div>
      </div>
    </div>
