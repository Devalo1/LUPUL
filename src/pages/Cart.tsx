        ...
        <div className="page-header-container">
          ...
          <div className="content-section bg-white p-8 text-center">
            ...
            <p className="text-gray-500 mb-6">
              Adaugă produse în coș pentru a putea finaliza o comandă.
            </p>
            <Link
              to="/magazin"
      ...
      <div className="page-header-container">
        ...
        <div className="content-section bg-white p-6">
          ...
          <div className="mt-8 border-t pt-6">
            <div className="flex justify-between items-center text-lg font-semibold mb-2 bg-gray-50 p-2 rounded">
            ...
            <div className="flex justify-between items-center text-2xl font-extrabold mb-6 bg-blue-50 p-4 rounded">
