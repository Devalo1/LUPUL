...
const CreateSessionPage: React.FC = () => {
  ...
  const [sessionRepeat, setSessionRepeat] = useState<
    "none" | "weekly" | "monthly"
  >("none");
      ...
      if (sessionRepeat !== "none" && sessionRepeatCount > 1) {
        ...
        for (let i = 0; i < sessionRepeatCount; i++) {
          ...
          const sessionData = {
            ...
            specialistName:
              profileData?.displayName || user.displayName || "Specialist",
          ...
          const docRef = await addDoc(
            collection(firestore, "specialSessions"),
            sessionData
          );
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      title="Repetare sesiune"
                      aria-label="Repetare sesiune"
                    >
                    ...
                    {sessionRepeat !== "none" && (
                      <input
                        ...
                        onChange={(e) =>
                          setSessionRepeatCount(Number(e.target.value))
                        }
                        min="1"
                        max="12"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  {sessionRepeat !== "none" && (
                    <p className="text-xs text-gray-500 mt-1">
                      Se vor crea {sessionRepeatCount} sesiuni{" "}
                      {sessionRepeat === "weekly" ? "săptămânale" : "lunare"}{" "}
                      începând cu data selectată.
                    </p>
                  )}
                </div>
