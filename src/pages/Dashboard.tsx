...
const Dashboard: React.FC = () => {  // Basic states
  const { user, loading, userRole: authUserRole, refreshUserData, logout } = useAuth();
  const navigate = useNavigate();
  ...
  return (
    <div className="container mx-auto px-4 py-8"> {/* No need for margin-top as it's handled by Layout */}
              ...
              <div>
                ...
                <p className="text-sm">
                  {firebaseRole === "specialist" && authUserRole !== "specialist" 
                    ...
                    : firebaseRole === "accountant" && authUserRole !== "accountant"
                    ? "Rolul de contabil a fost aprobat! Reîmprospătați sesiunea pentru a activa permisiunile noi."
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        >
                ...
                <motion.div 
                  ...
                  className={`mt-2 inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
                    userRoleEnum === UserRole.ADMIN 
                      ...
                      : userRoleEnum === UserRole.ACCOUNTANT
          ...
          <button
            ...
            className="mt-2 w-full py-2 bg-red-50 text-red-600 rounded-md hover:bg-red-100 transition duration-200 text-sm font-medium"
          >
            Deconectare
          </button>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Nou buton pentru contabili */}
            {userRoleEnum === UserRole.ACCOUNTANT && (
              <ActionCard
                icon={FaChartLine}
                title="Contabilitate"
                description="Accesează panoul de contabilitate"
                linkTo="/accounting"
      ...
      {/* Secțiuni specifice pentru roluri */}
      {userRoleEnum === UserRole.ACCOUNTANT && (
        <motion.section 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className="mt-8"
        >
          <h2 className="text-2xl font-bold mb-4">Panoul de Contabilitate</h2>
          <div className="bg-white rounded-lg shadow-md p-6">
            <p className="text-gray-600 mb-4">Accesați modulul de contabilitate pentru a gestiona rapoartele financiare și facturile.</p>
            <div className="grid md:grid-cols-3 gap-4">
              <ActionCard
                icon={FaChartLine}
                title="Rapoarte"
                description="Vizualizează rapoarte financiare"
                linkTo="/admin/accounting/reports"
                color="border-purple-500"
              />
              <ActionCard
                icon={FaCalculator}
                title="Facturi"
                description="Gestionează facturile"
                linkTo="/admin/accounting/invoices"
                color="border-purple-500"
              />
              <ActionCard
                icon={FaUserCog}
                title="Setări Contabilitate"
                description="Configurează modulul de contabilitate"
                linkTo="/admin/accounting/settings"
                color="border-purple-500"
              />
            </div>
          </div>
