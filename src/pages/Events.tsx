...
import { db } from '../firebase'; // Actualizat importul corect
import { Link } from 'react-router-dom';
import { useAuth } from '../contexts/AuthContext';
import Navbar from '../components/layout/Navbar'; // Adăugăm navbar pentru consistență UI
...
const Events: React.FC = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        setLoading(true);
        const eventsCollection = collection(db, 'events'); // Folosim db în loc de firestore
  ...
  return (
    <>
      <Navbar /> {/* Adăugăm Navbar pentru consistență */}
