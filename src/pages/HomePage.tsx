      ...
      <div className={`hero-section ${scrolled ? 'scrolled' : ''}`}>
        ...
        >
          ...
          >
            ...
            <div className="badge"><FaUsers /> Peste 10,000 clienți mulțumiți</div>
          </motion.div>
          ...
          >
            ...
            <div className="nav-buttons">
              <button onClick={toggleSideNav} className="btn-discover">
          ...
          >
            ...
            <span className="red-text">PENTRU ROMÂNI</span>
          </motion.div>
        </motion.div>
      </div>
