      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Introducere</h2>
            <p className="mb-4">
              Lupul și Corbul SRL („noi", „nouă", „al nostru") operează site-ul web lupulsicorbul.com 
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Date Colectate și Utilizare</h2>
            <p className="mb-4">
              Colectăm mai multe tipuri de informații în diverse scopuri pentru a vă furniza și 
              îmbunătăți Serviciul nostru.
            </p>

            <h3 className="text-lg font-medium mt-4 mb-2">Date Personale</h3>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Utilizarea Datelor Google</h2>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Date de Utilizare</h2>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Cookie-uri</h2>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Securitatea Datelor</h2>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Drepturile Dumneavoastră</h2>
            <p className="mb-4">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold mb-3">Modificări ale Politicii de Confidențialitate</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">Contactați-ne</h2>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6">
              ...
              <li>Prin poștă: Str. Exemplu nr. 123, București, România</li>
            </ul>
          </section>
        </div>
