      ...
      try {
        ...
        if (querySnapshot.empty) {
          ...
          const fetchedProducts = querySnapshot.docs.map(doc => {
            ...
            return {
              id: doc.id,
              name: (data as any).name || "Produs fără nume",
              description: (data as any).description || "Fără descriere",
              price: (data as any).price || 0,
              image: (data as any).image || "/images/AdobeStock_370191089.jpeg",
              inStock: (data as any).inStock !== undefined ? (data as any).inStock : true,
              stock: (data as any).stock || 0,
              category: (data as any).category || "necategorizat",
              ratings: (data as any).ratings || { average: 0, count: 0, userRatings: [] }
            } as Product;
          });
