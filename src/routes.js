...
export const routes = [
  ...
  // Using direct path mapping to ensure the accountant routes work
  { path: "/accountant", element: createElement(AccountantRoute, null, createElement(require('./pages/accountant/AccountantPanel').default)) },
  { path: "/accountant/panel", element: createElement(AccountantRoute, null, createElement(require('./pages/accountant/AccountantPanel').default)) },
  // Additional accountant routes
  ...accountantRoutes.map((route) => ({
    path: route.path,
    element: createElement(AccountantRoute, null, route.element)
  })),
  ...
  { path: "/accountant-panel", element: createElement(Navigate, { to: "/accountant", replace: true }) },
