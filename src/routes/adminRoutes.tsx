...
import EditSpecialist from "../pages/EditSpecialist";
...
export const adminRoutes: AdminRoute[] = [
  ...
  },
  {
    ...
    title: "Specialiști",
    description: "Gestionează specialiștii platformei",
    icon: "user-md"
  },
  {
    path: "/admin/specialists/add",
    element: <AddSpecialist />,
    title: "Adaugă Specialist",
    description: "Adaugă un specialist nou în platformă"
  },
  {
    path: "/admin/specialists/edit/:id",
    element: <EditSpecialist />,
    title: "Editează Specialist",
    description: "Editează informațiile unui specialist existent"
  },
  {
  ...
  },
  {
    ...
    title: "Contabilitate",
    description: "Accesați modulul de contabilitate",
    icon: "calculator"
  }
];
