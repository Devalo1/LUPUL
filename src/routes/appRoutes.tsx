...
import AccountantRoute from "../components/routes/AccountantRoute"; // Add import for AccountantRoute
import AdminLayout from "../layouts/AdminLayout";
import AccountingRoutes from "./accountingRoutes"; // Import accounting routes
import PrivateRoute from "./PrivateRoute"; // Import PrivateRoute
import AccountingDashboard from "../pages/AccountingDashboard"; // Import AccountingDashboard
import Unauthorized from "../pages/Unauthorized"; // Import pagina Unauthorized
import AccountantPanel from "../pages/accountant/AccountantPanel"; // Import AccountantPanel component
...
const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      {/* Redirect pentru backward compatibility cu vechiul URL */}
      <Route path="/specialist/panel" element={<Navigate to="/specialist" replace />} />
      ...
      {/* Rute pentru contabili - acces doar pentru rolul ACCOUNTANT */}
      <Route path="/accountant" element={
        <Navigate to="/accountant/panel" replace />
      } />
      <Route path="/accountant/panel" element={
        <AccountantRoute redirectTo="/dashboard">
          <AccountantPanel />
        </AccountantRoute>
      } />
      ...
      <Route path="/admin" element={
        ...
        {/* Accounting section routes */}
        <Route path="accounting/*" element={<AccountingRoutes />} />
      </Route>
      
      {/* Rută pentru pagina de acces restricționat */}
      <Route path="/unauthorized" element={<Unauthorized />} />
      
      {/* Panou pentru contabili - acces doar pentru rolul ACCOUNTANT */}
      <Route 
        path="/accounting/*" 
        element={
