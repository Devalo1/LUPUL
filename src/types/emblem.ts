...
export const EMBLEM_COLLECTIONS: Record<string, EmblemCollection> = {
  lupul_intelepta: {
    ...
    image: "/images/emblems/lupul_intelepta.svg",
    available: 10,
    tier: 4,
  },
  corbul_mistic: {
    ...
    image: "/images/emblems/corbul_mistic.svg",
    available: 15,
    tier: 3,
  },
  gardianul_wellness: {
    ...
    image: "/images/emblems/gardianul_wellness.svg",
    available: 25,
    tier: 2,
  },
  cautatorul_lumina: {
    ...
    image: "/images/emblems/cautatorul_lumina.svg",
    available: 50,
    tier: 1,
  },
};
