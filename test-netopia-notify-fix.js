...
async function testNetopiaNotify() {
  ...
  try {
    ...
    if (result1.statusCode === 200) {
      ...
      console.log("❌ Test 1 FAILED: Expected status 200, got", result1.statusCode);
    }
    ...
    if (result2.statusCode === 200) {
      console.log("✅ Test 2 PASSED: Returns status 200 even with invalid JSON");
    } else {
      console.log("❌ Test 2 FAILED: Expected status 200, got", result2.statusCode);
    }
    ...
    if (result3.statusCode === 200) {
      ...
      console.log("❌ Test 3 FAILED: Expected status 200, got", result3.statusCode);
    }
    ...
    if (result4.statusCode === 200) {
      console.log("✅ Test 4 PASSED: GET returns status 200 (safe for NETOPIA)");
    } else {
      console.log("❌ Test 4 FAILED: Expected status 200, got", result4.statusCode);
    }
    ...
    if (result5.statusCode === 200) {
      console.log("✅ Test 5 PASSED: Returns status 200 even with processing errors");
    } else {
      console.log("❌ Test 5 FAILED: Expected status 200, got", result5.statusCode);
    }
    
    console.log("\n🎉 ALL TESTS COMPLETED!");
    console.log("📊 Summary: All tests should return status 200 to avoid NETOPIA errors");
