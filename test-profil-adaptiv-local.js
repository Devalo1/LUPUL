...
function learnFromUserMessage(message, userId) {
  ...
  for (const pattern of namePatterns) {
    ...
    if (match && match[1] && match[1].length > 2) {
      ...
      // Evită să preia cuvinte comune ca nume
      const commonWords = [
        "bine",
        "aici",
        "acolo",
  ...
  const occupationPatterns = [
    /lucrez ca ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /sunt ([a-zA-ZăâîșțĂÂÎȘȚ\s]+) de profesie/i,
    /profesiunea mea este ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /muncesc ca ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /sunt un ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /sunt o ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
  ];
  ...
  const locationPatterns = [
    /locuiesc în ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /sunt din ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
    /trăiesc în ([a-zA-ZăâîșțĂÂÎȘȚ\s]+)/i,
  ];
