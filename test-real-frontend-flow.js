...
async function testRealFrontendFlow() {
    try {
        ...
        const realPayload = {
            ...
            amount: 25.00,  // Preț real pentru o sesiune
            currency: 'RON',
        ...
        console.log('2. Payload real (fără live forțat):', JSON.stringify(realPayload, null, 2));
        ...
        if (result.success && result.paymentUrl) {
            ...
            if (result.paymentUrl.includes('secure.netopia-payments.com')) {
                ...
                console.log('❓ Frontend-ul nu detectează credențialele live sau forțează sandbox');
